...
public class MainApp extends Application {
    ...
    private static Optional<Callback<Parent, Parent>> mCallback = Optional.empty();
    private static Optional<Callback<RootLayoutController, RootLayoutController>> mRootLayoutCallback = Optional.empty();
    ...
    public static void onLoad(Callback<Parent, Parent> r) {
        MainApp.mCallback = Optional.of(r);
    }
    
    public static void onRootLayoutLoad(Callback<RootLayoutController, RootLayoutController> r) {
        MainApp.mRootLayoutCallback = Optional.of(r);
    }
    ...
    public static ArrayList<Channel> getChannelsData(String filePathString) {
        ...
        System.out.println(mFilePathString + ".prm");
        if (fileParams.exists()) {
            ...
            System.out.println("mChannelsArrayList " + mChannelsArrayList.size());
    ...
    private void initRootLayout() { 
        try {
            ...
            mCallback.ifPresent(o -> o.call(mRootLayout));
            
            mRootLayoutCallback.ifPresent(o -> o.call(mRootLayoutController));
        } catch (IOException e) {
            e.printStackTrace();
        }
